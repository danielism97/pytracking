...
def parameters():
    ...
    deep_params.compressed_dim = [32,32]              # Dimension output of projection matrix
    ...
    deep_feat = deep.DRNetMobileNetSmall(net_path='drnet_cfkd.pth', output_layers=['layer3'], fparams=deep_fparams,
                                         normalize_power=2)
