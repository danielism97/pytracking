...
def parameters():
    ...
    params.CG_iter = 3                  # The number of Conjugate Gradient iterations in each update after the first frame
    ...
    # Training parameters
    params.sample_memory_size = 50     # Memory size
    ...
    params.hard_negative_CG_iter = 3            # Number of optimization iterations to use if hard negative detected
    ...
    deep_feat = deep.ATOMResNet18Tiny(net_path='ATOMnet_ep0001.pth.tar', output_layers=['layer3'], fparams=deep_fparams, normalize_power=2, use_gpu=False)
