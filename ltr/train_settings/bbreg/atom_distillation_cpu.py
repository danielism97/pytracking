...
def run(settings):
    ...
    settings.description = 'ATOM tiny IoUNet cpu version to be finetuned'
    ...
    net = atom_models.atom_resnet18tiny(backbone_pretrained=False, cpu=True)
    gpunet_path = '/content/pytracking/pytracking/networks/atom_tiny.pth.tar'
    net = loading.load_weights(net, gpunet_path, strict=False)
